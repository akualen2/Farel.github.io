...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2023 at 07:18 AM
...
--
DELIMITER $$
CREATE TRIGGER `triger_masyarakat` AFTER INSERT ON `masyarakat` FOR EACH ROW INSERT INTO pengaduan VALUES ('null','NEW','nama')
$$
DELIMITER ;
